...
const steps: readonly Step[] = [
    {
      id: "1",
      name: "Step 1",
      title: "Quick Sign-In & Project Setup",
      description:
        "Sign in and add your GitHub repository URL. If your available credits cover the project, you’ll be ready to start instantly.",
    },
    {
      id: "2",
      name: "Step 2",
      ...
      description:
        "Ask questions and get answers based on your commits, enhanced with AI-generated summaries of your commit history.",
    },
    {
      id: "3",
      name: "Step 3",
      ...
      description:
        "Upload your meeting audio files and let AI generate accurate transcriptions and concise summaries for your team.",
    },
    {
      id: "4",
      name: "Step 4",
      ...
      description:
        "Easily manage and top up your credits with secure, hassle-free payments powered by Stripe.",
    },
  ];
...
// --- Hooks ---
function useNumberCycler(totalSteps: number = TOTAL_STEPS, interval = 5000) {
...
const defaultClasses = {
  ...
  step2img2: "w-[40%] left-[55%] top-[35%]",
  step3img: "w-[90%] left-[5%] top-[25%]",
  step4img: "w-[100%] left-[5%] top-[10%]",
} as const
